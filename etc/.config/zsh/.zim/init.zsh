# FILE AUTOMATICALLY GENERATED FROM /home/tom/.config/zsh/.zimrc
# EDIT THE SOURCE FILE AND THEN RUN zimfw build. DO NOT DIRECTLY EDIT THIS FILE!

if [[ -e ${ZIM_CONFIG_FILE:-${ZDOTDIR:-${HOME}}/.zimrc} ]] zimfw() { source "${HOME}/tlnx/etc/.config/zsh/.zim/zimfw.zsh" "${@}" }
fpath=("${HOME}/.config/zsh/.zim/modules/git/functions" "${HOME}/.config/zsh/.zim/modules/utility/functions" "${HOME}/.config/zsh/.zim/modules/duration-info/functions" "${HOME}/.config/zsh/.zim/modules/git-info/functions" "${HOME}/.config/zsh/.zim/modules/completion/functions" "${HOME}/.config/zsh/.zim/modules/archive/functions" "${HOME}/.config/zsh/.zim/modules/history-search-multi-word/functions" ${fpath})
...
source "${HOME}/.config/zsh/.zim/modules/exa/init.zsh"
source "${HOME}/.config/zsh/.zim/modules/fzf/init.zsh"
source "${HOME}/.config/zsh/.zim/modules/archive/init.zsh"
